...
let g:colors_name="fight-in-the-shade"
...
call s:HL('Cursor',       defaultBackground, defaultForeground, 'none')      " The character under the cursor, has no effect in the terminal
...
call s:HL('Search',       arcadian,          'none',            'underline') " The highlighting for the last search pattern
...
call s:HL('MatchParen',   smoke,             arcadian,          'bold')      " The opening or closing sibling of the currently highlighted bracket
call s:HL('Visual',       persian,           defaultForeground, 'none')      " The visual mode selection
call s:HL('NonText',      smoke,             'none',            'none')      " For characters that did not really exist in the text
call s:HL('Todo',         xerxes,            defaultBackground, 'bold')      " Keywords like; TODO, FIXME, XXX
call s:HL('Underlined',   persian,           'none',            'underline') " HTML anchor tag
call s:HL('Error',        arcadian,          leonidas,          'none')      " Error highlighting
call s:HL('ErrorMsg',     arcadian,          leonidas,          'none')      " Error messages on the command line
...
call s:HL('LineNr',       defaultForeground, 'none',            'none')      " Line number used in quick fix window
...
call s:HL('PmenuSel',   arcadian,          defaultForeground, 'reverse')
call s:HL('PmenuSbar',  defaultForeground, 'none',            'none')
call s:HL('PmenuThumb', leonidas,          'none',            'none')

" Spelling
call s:HL('SpellBad',   arcadian, leonidas, 'underline')
